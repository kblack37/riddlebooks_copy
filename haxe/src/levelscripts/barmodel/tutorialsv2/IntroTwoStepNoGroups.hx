...
class IntroTwoStepNoGroups extends BaseCustomLevelScript
{
    ...
    private var m_barElementIdsToHighlight : Array<String>;
    ...
    private var m_jobToTotalMapping : Dynamic = {
            ninja : {
                unknown_a_name : "nightengale floors",
                unknown_a_abbr : "floors",
                unknown_b_name : "trap doors",
                unknown_b_abbr : "doors",
                hint_add : "both kinds of obstacles",
                numeric_unit_total : "obstacles",
                numeric_unit_diff : "obstacles",

            },
            zombie : {
                unknown_a_name : "gas bomb cure",
                unknown_a_abbr : "bomb",
                unknown_b_name : "spray cure",
                unknown_b_abbr : "spray",
                hint_add : "both kinds of cure delivery",
                numeric_unit_total : "zombies",
                numeric_unit_diff : "zombies",

            },
            basketball : {
                unknown_a_name : "first half shots",
                unknown_a_abbr : "first",
                unknown_b_name : "second half shots",
                unknown_b_abbr : "second",
                hint_add : "shots in each half",
                numeric_unit_total : "shots",
                numeric_unit_diff : "shots",

            },
            fairy : {
                unknown_a_name : "mudballs hit",
                unknown_a_abbr : "hit",
                unknown_b_name : "mudballs miss",
                unknown_b_abbr : "miss",
                hint_add : "mudballs hit and missed",
                numeric_unit_total : "mudballs",
                numeric_unit_diff : "mudballs",

            },
            superhero : {
                unknown_a_name : "open barrels",
                unknown_a_abbr : "open",
                unknown_b_name : "closed barrels",
                unknown_b_abbr : "closed",
                hint_add : "barrels opened and closed",
                numeric_unit_total : "barrels",
                numeric_unit_diff : "barrels",
            ...
            isActive : Bool = true)
    {
        ...
        m_barElementIdsToHighlight = new Array<String>();
    ...
    override public function visit() : Int
    {
        if (m_ready) 
        {
            ...
            {
                var addedFirstUnknown : Bool = false;
                var addedSecondUnknown : Bool = false;
    ...
    override private function onLevelReady() : Void
    {
        ...
        sequenceSelector.pushChild(new CustomVisitNode(
                function(param : Dynamic) : Int
                {
                    ...
                    setDocumentIdsSelectable([m_unknownSmallerDocId, m_unknownLargerDocId], true, 1);
                    ...
                    dataForCard.abbreviatedName = m_sum + " " + Reflect.field(m_jobToTotalMapping, selectedPlayerJob).numeric_unit_total;
                    dataForCard = m_gameEngine.getExpressionSymbolResources().getSymbolDataFromValue(m_difference);
                    dataForCard.abbreviatedName = m_difference + " " + Reflect.field(m_jobToTotalMapping, selectedPlayerJob).numeric_unit_diff;
        ...
        sequenceSelector.pushChild(new CustomVisitNode(
                function(param : Dynamic) : Int
                {
                    ...
                    setDocumentIdsSelectable([m_sumDocId], true, 1);
        ...
        sequenceSelector.pushChild(new CustomVisitNode(
                function(param : Dynamic) : Int
                {
                    ...
                    setDocumentIdsSelectable([differenceDocId], true, 1);
        ...
        sequenceSelector.pushChild(new CustomVisitNode(
                function(param : Dynamic) : Int
                {
                    ...
                    m_validateEquation.addEquationSet(["1", "2"]);
                    ...
                    var barWholes : Array<BarWholeView> = m_barModelArea.getBarWholeViews();
                    for (barWhole in barWholes)
                    {
                    ...
                    for (barElementId in m_barElementIdsToHighlight)
                    {
    ...
    private function showAddUnknownHint() : Void
    {
        ...
        showDialogForUi({
                    id : "barModelArea",
                    text : "Add boxes for " + jobData.hint_add + "!",
                    color : 0x5082B9,
    ...
    private function showSumHint() : Void
    {
        ...
        showDialogForUi({
                    id : "barModelArea",
                    text : "Add total for " + jobData.hint_add + "!",
                    color : 0x5082B9,
