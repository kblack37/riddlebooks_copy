...
interface IExpressionTreeCompiler
{
     ...
     */
    function setDynamicVariableInformation(dynamicVariableCharacters : Array<String>, nodeCreateCallback : Function) : Void;
     ...
     *      form (data * unit_value).
		 ...
		 */
    function decompileAtNode(expressionTreeNode : ExpressionNode, expandUnits : Bool = true) : String;
    ...
    /**
		 ...
		 */
    function isOperator(data : String) : Bool;
}
