...
import wordproblem.account.ArtPrizeFishBowl;
 ...
 */
class RegisterStudentPlaytestState extends Sprite implements IDisposable
{
            ...
            descriptionText : String = null)
    {
        ...
        m_registerAccountScreen.layoutFunction = function defaultLayout(background : DisplayObject,
                        ...
                        registerFailMessage : TextField) : Void
                {
                    ...
                    var inputHorizontalLine : Float = 295;
        ...
        m_registerAccountScreen.descriptionFactory = function defaultDescriptionFactory() : DisplayObject
                {
                    ...
                    var prizeBox : MovieClip = new ArtPrizeFishBowl();
                    prizeBox.stop();
    ...
    private function onRegisterSuccess(user : ICgsUser) : Void
    {
        ...
        function tosAccepted() : Void
        {
            ...
            m_registerRewardScreen.animationFactory = function defaultAnimationFactory() : MovieClip
                    {
                        var animation : MovieClip = new ArtPrizeFishBowl();
                        animation.stop();
                        return animation;
                    };
            ...
            m_registerRewardScreen.layoutFunction = function defaultLayout(background : DisplayObject,
                            ...
                            okButton : Button) : Void
                    {
                        ...
                        var delayTween : GTween = new GTween(null, 0.5, null, {
                            onComplete : function(tween : GTween) : Void
                            {
                                animation.play();
                                
                                Audio.instance.playSfx("reward");
                                
                                var animationPlayTween : GTween = new GTween(null, 2.3, null, {
                                    onComplete : function(tween : GTween) : Void
                                    {
                                        animation.stop();
                                        
                                        descriptionText.alpha = 0.0;
                                        var desciptionTween : GTween = new GTween(descriptionText, 1, {
                                            alpha : 1.0
                                        ...
                                        okButton.alpha = 0.0;
                                        var buttonTween : GTween = new GTween(okButton, 1, {
                                            alpha : 1.0
