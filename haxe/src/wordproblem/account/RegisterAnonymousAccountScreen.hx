 ...
 * account.
 */
class RegisterAnonymousAccountScreen extends Sprite implements IDisposable
{
    ...
    private function checkRegisterEnabled() : Void
    {
        ...
        var iconsToRemove : Array<DisplayObject> = new Array<DisplayObject>();
        iconsToRemove.push(m_userNameAcceptableIcon);
        iconsToRemove.push(m_userNameNotAcceptableIcon);
        iconsToRemove.push(m_gradeSelectedIcon);
        iconsToRemove.push(m_gradeNotSelectedIcon);
        iconsToRemove.push(m_genderSelectedIcon);
        iconsToRemove.push(m_genderNotSelectedIcon);
