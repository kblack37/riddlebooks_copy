 ...
 */
class BarModelToExpressionAnimation
{
    /**
    ...
    public static function convertBarModelViewsToSingleImage(barModelViews : Array<DisplayObject>,
            ...
            scaleFactor : Float,
            outTotalBoundsBuffer : Rectangle = null) : DisplayObject
    {
        var i : Int = 0;
        ...
        var barModelBitmapData : BitmapData = new BitmapData(Std.int(totalBoundsBuffer.width), Std.int(totalBoundsBuffer.height), false);
		for (i in 0...numViews) {
			...
			barModelBitmapData.draw(barModelView, new Matrix(scaleFactor, 0, 0, scaleFactor, xOffset, yOffset));
		}
        ...
        return new Bitmap(barModelBitmapData);
    }
	// TODO: the non-static methods aren't used anywhere and require extensive rework; to expedite conversion, they've been commented out
    //
    ///**
