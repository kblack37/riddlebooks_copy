...
class LevelStatistics
{
     ...
     */
    public var usedBarModelCheatHint : Bool;
    
    /**
     * A level might have a hint that shows the exact equation model answer
     */
    public var usedEquationModelCheatHint : Bool;
     ...
     * have solved it.
     */
    public var totalMillisecondsPlayed : Float;
     ...
     */
    public var xpEarnedForLevel : Int;
    ...
    public function deserialize(data : Dynamic) : Void
    {
        if (data != null) 
        {
            if (data.exists("barModelFails")) 
            {
                this.barModelFails = Reflect.field(data, "barModelFails");
            }
            
            if (data.exists("equationModelFails")) 
            {
                this.equationModelFails = Reflect.field(data, "equationModelFails");
            }
            
            if (data.exists("hintsRequested")) 
            {
                this.additionalHintsUsed = Reflect.field(data, "hintsRequested");
            }
        }
    }
