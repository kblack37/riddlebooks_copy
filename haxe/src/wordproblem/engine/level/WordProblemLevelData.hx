 ...
 */
class WordProblemLevelData
{
    public var difficulty(get, set) : Float;
     ...
     */
    public var objectives : Array<BaseObjective>;
     ...
     */
    public var termValueToBarModelValue : Dynamic;
     ...
     */
    public var prepopulateEquationData : Dynamic;
     ...
     */
    public var m_rootDocumentNode : Array<DocumentNode>;
     ...
     */
    private var m_cssStyleObject : Dynamic;
    
    /**
     * Custom card values to be used in the level.
     */
    private var m_symbolData : Array<SymbolData>;
    
    /**
     * The tree structure for custom logic to be executed for the level.
     */
    private var m_scriptRoot : ScriptNode;
    private var m_imagesToLoad : Array<String>;
    private var m_audioData : Array<Dynamic>;
    private var m_textureAtlasesToLoad : Array<Array<String>>;
    ...
    public function new(levelId : Int,
            ...
            genreId : String,
            name : String,
            rootDocumentNode : Array<DocumentNode>,
            cssStyleObject : Dynamic,
            symbolData : Array<SymbolData>,
            scriptNode : ScriptNode,
            imagesToLoad : Array<String>,
            audioData : Array<Dynamic>,
            textureAtlasesToLoad : Array<Array<String>>,
            ...
            barModelType : String)
    {
        ...
        this.objectives = new Array<BaseObjective>();
     ...
     */
    public function getRootDocumentNodes() : Array<DocumentNode>
    {
     ...
     */
    public function getCssStyleObject() : Dynamic
    {
     ...
     */
    public function getSymbolsData() : Array<SymbolData>
    {
        return m_symbolData;
    }
     ...
     */
    public function getImagesToLoad() : Array<String>
    {
     ...
     *      }
     */
    public function getAudioData() : Array<Dynamic>
    {
        return m_audioData;
    }
     ...
     */
    public function getTextureAtlasesToLoad() : Array<Array<String>>
    {
     ...
     */
    private function get_difficulty() : Float
    {
        return m_difficulty;
    }
    
    private function set_difficulty(value : Float) : Float
    {
    ...
    private function set_tags(value : Array<String>) : Array<String>
    {
        m_tags = value;
        return value;
    }
