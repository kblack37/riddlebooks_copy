...
class GameEvent
{
     ...
     */
    public static inline var ADD_TERM_ATTEMPTED : String = "add_term_attempted";
     ...
     */
    public static inline var REMOVE_TERM : String = "remove_term";
     ...
     */
    public static inline var CHANGED_OPERATOR : String = "changed_operator";
     ...
     */
    public static inline var EXPRESSION_REVEALED : String = "expression_revealed";
     ...
     */
    public static inline var EXPRESSION_RELEASED_NO_REVEAL : String = "expression_released_no_reveal";
     ...
     */
    public static inline var EQUATION_MODEL_SUCCESS : String = "equation_modeled";
     ...
     */
    public static inline var EQUATION_MODEL_FAIL : String = "equation_modeled_fail";
     ...
     */
    public static inline var EQUATION_CHANGED : String = "equation_changed";
     ...
     */
    public static inline var END_DRAG_TERM_WIDGET : String = "end_drag_new_term";
     ...
     */
    public static inline var START_DRAG_TERM_WIDGET : String = "start_drag_new_term";
     ...
     * origin:display object widget that drag originated from
     */
    public static inline var END_DRAG_EXISTING_TERM_WIDGET : String = "end_drag_existing_term";
     ...
     */
    public static inline var START_DRAG_EXISTING_TERM_WIDGET : String = "start_drag_existing_term";
     ...
     */
    public static inline var RELEASED_DRAG_DECK_AREA : String = "released_drag_deck_area";
     ...
     */
    public static inline var START_DRAG_DECK_AREA : String = "start_drag_deck_area";
     ...
     */
    public static inline var SELECT_DECK_AREA : String = "select_deck_area";
     ...
     */
    public static inline var START_DRAG_TERM_AREA : String = "start_drag_term_area";
     ...
     * termArea: the TermAreaWidget the dragged widget was part of
     */
    public static inline var PRESS_TERM_AREA : String = "press_term_area";
     ...
     * termArea: the TermAreaWidget the dragged widget was part of
     */
    public static inline var CLICK_TERM_AREA : String = "click_term_area";
     ...
     */
    public static inline var PRESS_PARENTHESIS_TERM_AREA : String = "press_parenthesis_term_area";
     ...
     */
    public static inline var PRESS_TEXT_AREA : String = "press_text_area";
     ...
     */
    public static inline var START_DRAG_TEXT_AREA : String = "start_drag_text_area";
     ...
     */
    public static inline var RELEASE_TEXT_AREA : String = "release_text_area";
     ...
     * None
     */
    public static inline var TEXT_AREA_REDRAWN : String = "text_area_redrawn";
     ...
     */
    public static inline var TERM_AREA_RESET : String = "term_area_reset";
     ...
     */
    public static inline var TERM_AREA_CHANGED : String = "term_area_changed";
    public static inline var TERM_AREA_CARD_DROP : String = "term_area_card_drop";
     ...
     */
    public static inline var TERM_AREAS_CHANGED : String = "term_areas_changed";
     ...
     */
    public static inline var SELECT_INVENTORY_AREA : String = "select_inventory_area";
     ...
     */
    public static inline var START_DRAG_INVENTORY_AREA : String = "start_drag_inventory_area";
     ...
     */
    public static inline var EXPAND_INVENTORY_AREA : String = "expand_inventory_area";
     ...
     */
    public static inline var EXPRESSION_PICKER_SELECT_OPTION : String = "expression_picker_select_option";
     ...
     * pickerId: Id of the picker widget
     */
    public static inline var EXPRESSION_PICKER_DESELECT_OPTION : String = "expression_picker_deselect_option";
     ...
     * no params right now
     */
    public static inline var EXPRESSION_PICKER_CORRECT : String = "expression_picker_correct";
     ...
     * no params right now
     */
    public static inline var EXPRESSION_PICKER_INCORRECT : String = "expression_picker_incorrect";
     ...
     */
    public static inline var BAR_MODEL_AREA_CHANGE : String = "bar_model_area_change";
     ...
     */
    public static inline var BAR_MODEL_AREA_REDRAWN : String = "bar_model_area_redrawn";
     ...
     */
    public static inline var BAR_MODEL_INCORRECT : String = "bar_model_incorrect";
    
    /**
     * Fired when an attempt to validate the contents of the bar model area
     * is successful, it correctly match one of the supplied answers.
     */
    public static inline var BAR_MODEL_CORRECT : String = "bar_model_correct";
    
    /**
     * Fired when all the resources of a level are loaded and ready.
     * Scripts can start setup of logic.
     */
    public static inline var LEVEL_READY : String = "level_ready";
     ...
     */
    public static inline var LEVEL_SOLVED : String = "level_solved";
     ...
     * no parameters
     */
    public static inline var LEVEL_COMPLETE : String = "level_complete";
    
    /**
     * Fired when the player has selected the various buttons.
     */
    public static inline var HINT_BUTTON_SELECTED : String = "hint_button_selected";
    public static inline var OPTIONS_SELECTED : String = "options_selected";
    public static inline var UNDO_SELECTED : String = "undo_selected";
    public static inline var RESUME_SELECTED : String = "resume_selected";
    public static inline var SKIP_SELECTED : String = "skip_selected";
    public static inline var MUSIC_SELECTED : String = "music_selected";
    public static inline var SFX_SELECTED : String = "sfx_selected";
    public static inline var MENU_SELECTED : String = "menu_selected";
     ...
     * the new one.
     */
    public static inline var SHOW_HINT : String = "show_hint";
     ...
     */
    public static inline var GET_NEW_HINT : String = "get_new_hint";
     ...
     */
    public static inline var REMOVE_HINT : String = "remove_hint";
     ...
     * gender
     */
    public static inline var UPDATE_GRADE_GENDER : String = "update_grade_gender";
     ...
     */
    public static inline var ADD_NEW_EQUATION : String = "add_new_equation";
     ...
     */
    public static inline var ADD_NEW_BAR_MODEL : String = "add_new_bar_model";
     ...
     * tipName
     */
    public static inline var LINK_TO_TIP : String = "link_to_tip";
     ...
     */
    public static inline var OPEN_RADIAL_OPTIONS : String = "open_radial_options";
    
    /**
     * Fired when the radial options menu has been closed and destroyed.
     */
    public static inline var CLOSE_RADIAL_OPTIONS : String = "close_radial_options";
    
    /**
     * Fired when the player starts a resize operation on a label
     */
    public static inline var START_RESIZE_HORIZONTAL_LABEL : String = "start_resize_horizontal_label";
