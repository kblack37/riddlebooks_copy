...
class EquationToTextWidget extends Sprite
{
    ...
    public function setText(text : String, root : ExpressionNode) : Void
    {
        ...
        m_textField = new TextField(Std.int(m_maxWidth), Std.int(m_maxHeight), text, m_defaultTextFormat.font, targetFontSize, try cast(m_defaultTextFormat.color, Int) catch(e:Dynamic) null);
