...
class ExpressionTreeEvent
{
     ...
     */
    public static inline var ADD_BATCH : String = "add_batch";
     ...
     */
    public static inline var SUBSTITUTE : String = "substitute";
     ...
     * just added.
     */
    public static inline var DISTRIBUTE : String = "distribute";
     ...
     */
    public static inline var SIMPLIFY_SINGLE : String = "simplify_single";
     ...
     * nodeIds: Vector of int ids of nodes that were simplified
     */
    public static inline var SIMPLIFY_PAIR : String = "simplify_pair";
     ...
     * nodeIds: Vector of int ids of nodes that were simplified
     */
    public static inline var SIMPLIFY_CLUSTER : String = "simplify_cluster";
