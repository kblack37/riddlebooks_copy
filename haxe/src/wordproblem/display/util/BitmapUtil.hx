package wordproblem.display.util;
...
class BitmapUtil
{
     ...
     * no longer used.
     */
    public static function getImageFromDisplayObject(displayObject : DisplayObject, scaleFactor : Float = 1.0) : Bitmap
    {
     ...
     */
    public static function getRingSegmentBitmapData(innerRadius : Float,
            outerRadius : Float,
            startAngleRad : Float,
            radToFill : Float,
            clockwise : Bool,
            ...
            outlineColor : Int = 0x000000) : BitmapData
    {
