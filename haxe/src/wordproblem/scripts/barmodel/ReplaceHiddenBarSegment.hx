 ...
 */
class ReplaceHiddenBarSegment extends BaseBarModelScript
{
    /**
    ...
    override public function visit() : Int
    {
        ...
        if (m_ready && m_isActive) 
        {
            ...
            if (m_bufferedEventTypes.length > 0) 
            {
                ...
                {
                    var hitHiddenBarSegmentId : String = try cast(m_outParamsBuffer[0], String) catch(e:Dynamic) null;
            ...
            else if (m_widgetDragSystem.getWidgetSelected() != null) 
            {
                ...
                {
                    hitHiddenBarSegmentId = try cast(m_outParamsBuffer[0], String) catch(e:Dynamic) null;
