 ...
 * table here.
 */
class WordProblemGameDefault extends WordProblemGameBase
{
    ...
    override private function onStartLevel(id : String, src : String, extraLevelProgressionData : Dynamic = null) : Void
    {
        ...
        if (m_lockAnonymousAccountController != null && m_lockAnonymousAccountController.getShouldAccountBeLocked()) 
        {
            ...
            m_stateMachine.changeState(WordProblemSelectState, null);
            (try cast(m_stateMachine.getStateInstance(WordProblemSelectState), WordProblemSelectState) catch(e:Dynamic) null).isActive = false;
            ...
            function onRegisterCancel() : Void
            {
                ...
                onWaitHide();
                (try cast(m_stateMachine.getStateInstance(WordProblemSelectState), WordProblemSelectState) catch(e:Dynamic) null).isActive = true;
            };
    ...
    override private function onLevelLoadError(levelId : String, url : String) : Void
    {
        onWaitHide();
        m_stateMachine.changeState(WordProblemSelectState);
