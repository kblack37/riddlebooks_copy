 ...
 */
class CurrencyParticlesAnimation implements IAnimatable
{
     ...
     */
    private var m_timeSpentRunning : Float;
    
    
    public function new(coinTexture : Texture, canvas : DisplayObjectContainer)
    {
        m_canvas = canvas;
        ...
        m_emitter.addInitializer(new TextureUVInitializer([coinTextureBounds], coinTextureBounds));
