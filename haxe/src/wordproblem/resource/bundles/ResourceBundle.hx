...
class ResourceBundle
{
     ...
     */
    public static inline var STARLING_ASSET_COMPATIBLE : String = "starling_compatible";
     ...
     */
    public static inline var URL_ASSETS : String = "url_assets";
     ...
     */
    private var m_nameToResourceMap : Dynamic;
     ...
     */
    public function getNameToResourceMap() : Dynamic
    {
