 ...
 */
class WordProblemCreateState extends BaseState
{
    /**
    ...
    override public function enter(fromState : Dynamic, params : Array<Dynamic> = null) : Void
    {
        ...
        m_problemCreateData = try cast(params[0], ProblemCreateData) catch(e:Dynamic) null;
        ...
        var sidePadding : Float = 100;
        var textAreaWidth : Float = screenWidth - 2 * sidePadding;
        var textAreaHeight : Float = 270;
        m_editableTextArea.setConstraints(textAreaWidth, textAreaHeight);
        
        var topPadding : Float = 50;
        var textAreaX : Float = (screenWidth - m_editableTextArea.getConstraints().width) * 0.5;
        var textAreaY : Float = topPadding;
        ...
        var barModelAllowedWidth : Float = screenWidth - 2 * sidePadding;
        var barModelAllowedHeight : Float = 220;
        ...
        var partNames : Array<String> = new Array<String>();
        ...
        var rightEdgeOfBarModel : Float = m_barModelArea.x + m_barModelArea.getConstraints().width;
        ...
        var optionsButtonWidth : Float = 150;
        var optionsButtonHeight : Float = 40;
    ...
    public function getWidgetFromId(id : String) : DisplayObject
    {
        ...
        var renderComponent : RenderableComponent = try cast(m_uiComponentManager.getComponentFromEntityIdAndType(
                id, RenderableComponent.TYPE_ID), RenderableComponent) catch(e:Dynamic) null;
