...
class ProblemCreateEvent
{
     ...
     */
    public static inline var USER_HIGHLIGHT_STARTED : String = "user_highlight_started";
    
    /**
     * params:
     * {id: high level id of the element bound to the new highlight}
     */
    public static inline var USER_HIGHLIGHT_FINISHED : String = "user_highlight_finished";
    
    /**
     * Dispatched when highlighting in cancelled, it should have no affect
     */
    public static inline var USER_HIGHLIGHT_CANCELLED : String = "user_highlight_cancelled";
     ...
     */
    public static inline var HIGHLIGHT_REFRESHED : String = "highlight_refreshed";
    
    public static inline var PROBLEM_CREATE_INIT : String = "create_problem_init";
     ...
     */
    public static inline var SELECT_BAR_ELEMENT : String = "select_bar_element";
     ...
     */
    public static inline var MOUSE_OUT_BAR_ELEMENT : String = "mouse_out_bar_element";
     ...
     * elementId: the id the specific piece in the current bar model
     */
    public static inline var MOUSE_OVER_BAR_ELEMENT : String = "mouse_over_bar_element";
     ...
     * None so far
     */
    public static inline var BAR_PART_VALUE_CHANGED : String = "bar_part_value_changed";
    
    /**
     * Dispatched when the user has altered the background of the problem they are editing
     */
    public static inline var BACKGROUND_AND_STYLES_CHANGED : String = "background_and_styles_changed";
     ...
     */
    public static inline var SHOW_EXAMPLE_START : String = "show_example_start";
     ...
     */
    public static inline var SHOW_EXAMPLE_END : String = "show_example_end";
    
    /**
     * Dispatched when the player wants to exit the testing level.
     */
    public static inline var TEST_LEVEL_EXIT : String = "test_level_exit";
