...
class VisualizationUtilities
{
    ...
    /**
		 ...
		 * @return
		 */
    public static function computeColorArray(baseColor : Int, factorOne : Float, factorThree : Float) : Array<Dynamic>
    {
    ...
    public static function getNumeratorSubsetOfFraction(aFraction : CgsFraction, unitIndex : Int = 0) : Int
    {
        ...
        return Math.min(aFraction.numerator - unitIndex * aFraction.denominator, aFraction.denominator);
    }
