...
class StripFractionModule implements IFractionModule
{
    ...
    /**
		 ...
		 * @param	ratios
		 */
    private function drawSegmentBlock(targetG : Graphics, blockX : Float, blockY : Float, blockWidth : Float, blockHeight : Float, colors : Array<Dynamic>, alphas : Array<Dynamic>, ratios : Array<Dynamic>) : Void
    {
