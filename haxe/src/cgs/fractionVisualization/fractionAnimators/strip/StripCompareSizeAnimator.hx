...
class StripCompareSizeAnimator implements IFractionAnimator
{
    ...
    public function animate(details : Dynamic, completeCallback : Function) : Void
    {
        ...
        var winningModule : StripFractionModule = null;
        ...
        if (winnerExists)
        {
            ...
            var glowColor : Int = (details.exists(CgsFVConstants.WINNING_GLOW_COLOR)) ? Reflect.field(details, Std.string(CgsFVConstants.WINNING_GLOW_COLOR)) : CgsFVConstants.ANIMATION_WINNING_GLOW_COLOR;
