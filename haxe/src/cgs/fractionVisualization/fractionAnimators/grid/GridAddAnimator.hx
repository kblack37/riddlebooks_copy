...
class GridAddAnimator implements IFractionAnimator
{
    ...
    public function animate(details : Dynamic, completeCallback : Function) : Void
    {
        ...
        var textGlowColor : Int = (Reflect.hasField(detailsReflect.hasField(CgsFVConstants.TEXT_GLOW_COLOR)) ? Reflect.field(details, Std.string(CgsFVConstants.TEXT_GLOW_COLOR)) : GenConstants.DEFAULT_TEXT_GLOW_COLOR;
