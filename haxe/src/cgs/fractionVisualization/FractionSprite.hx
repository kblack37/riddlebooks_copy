...
class FractionSprite extends Sprite
{
    ...
    public var representationState(get, never) : Dynamic;
    ...
    private var m_representationState : Dynamic;
    ...
    /**
		 ...
		 */
    private function get_representationState() : Dynamic
    {
