...
{
    public static var staticTypeMap(get, never) : Dictionary;
     ...
     */
    private static function get_staticTypeMap() : Dictionary
    {
        if (!_typeMap)
        {
    ...
    override private function get_typeMap() : Dictionary
    {
