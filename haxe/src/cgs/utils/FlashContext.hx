...
class FlashContext
{
    ...
    {
        return _flashVars.exists(USERID_KEY);
    }
    
    private function get_containsGradeLevel() : Bool
    {
        return _flashVars.exists(GRADE_LEVEL_KEY);
    }
    ...
    {
        return _flashVars.exists(EDMODO_EXT_DATA_KEY) && _flashVars.exists(EDMODO_DATA_KEY);
    }
    ...
    {
        return _flashVars.exists(TEACHER_CODE_KEY);
    }
