package gameconfig.versions.replay.scripts
{
     ...
     */
    public class ReplayBarModelLevel extends BaseGameScript
    {
        private var m_switchModelScript:SwitchBetweenBarAndEquationModel;
        private var m_uiSetUp:Boolean;
        
        public function ReplayBarModelLevel(gameEngine:IGameEngine, 
        ...
        override public function visit():int
        {
            if (m_isActive && m_ready)
            {
                ...
                {
                    // Ui container
                    var originalYLocation:Number = 270;
