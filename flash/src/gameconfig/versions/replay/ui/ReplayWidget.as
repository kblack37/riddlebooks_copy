package gameconfig.versions.replay.ui
{
     ...
     */
    public class ReplayWidget extends Sprite
    {
        ...
        public function ReplayWidget(assetManager:AssetManager, actions:Array)
        {
            super();
            
            m_actions = actions;
            
            var totalWidth:Number = 500;
            var totalHeight:Number = 150;
            ...
            var inputWidth:Number = 100;
            var inputHeight:Number = m_nextActionButton.height;
        ...
        {
            dispatchEventWith(ReplayEvents.GO_TO_ACTION_AT_INDEX, false, {actionIndex: m_currentQuestActionIndex});
