package gameconfig.versions.replay.state
{
    ...
    public class ReplayTitleState extends BaseState
    {
        private var m_assetManager:AssetManager;
        private var m_dqidInput:TextInput;
        
        public function ReplayTitleState(stateMachine:IStateMachine, 
        ...
        private function onSubmitDqidClicked():void
        {
            ...
            dispatchEventWith(ReplayEvents.GO_TO_REPLAY_FOR_DQID, false, {dqid: dqid});
        }
    }
}