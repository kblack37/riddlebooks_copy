package gameconfig.versions.challenge0316
{
     ...
     */
    public class WordProblemGameChallenge0316 extends WordProblemGameBase
    {
        ...
        */
        private static const DUMMY_GRADE:int = 2;
        ...
        */
        ...
        private static const DEFAULT_USE_CUSTOM_HINTS:Boolean = true;
        ...
        public function WordProblemGameChallenge0316()
        {
            super();
        ...
        */
        ...
        private function setUpGameForFirstTime(userGrade:int):void
        {
            ...
            // TODO: Initialize batch save data.
            // At this point, all the data belonging to the user has already been setup need a
            // script
            ...
            var useCustomHints:Boolean = DEFAULT_USE_CUSTOM_HINTS;
            if (m_logger.getCgsUser() != null)
            {
