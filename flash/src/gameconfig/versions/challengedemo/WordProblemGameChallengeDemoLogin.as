package gameconfig.versions.challengedemo
{
     ...
     */
    public class WordProblemGameChallengeDemoLogin extends BaseState
    {
        ...
        public function WordProblemGameChallengeDemoLogin(stateMachine:IStateMachine, 
        ...
        override public function enter(fromState:Object, params:Vector.<Object>=null):void
        {
            ...
            var gradeComboBoxWidth:Number = 100;
        ...
        override public function exit(toState:Object):void
        {
            ...
            if (m_gradeComboBox && m_gradeComboBox.parent)
            {
