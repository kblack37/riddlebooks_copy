package gameconfig.versions.copilot
{
    ...
    public class WordProblemGameCopilot extends WordProblemGameBase
    {
        /**
        ...
        public function WordProblemGameCopilot()
        {
            super();
        }
        ...
        override protected function onUserAuthenticated():void
        {
            ...
            {
                m_playerStatsAndSaveData = new PlayerStatsAndSaveData(null)
                ...
                const expressionSymbolMap:ExpressionSymbolMap = new ExpressionSymbolMap(m_assetManager);
                const expressionCompiler:IExpressionTreeCompiler = new LatexCompiler(new RealsVectorSpace());
