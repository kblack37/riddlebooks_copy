package starling.extensions
{
    ...
    {
        [Embed(source="/../assets/shaders/polygon.agal",mimeType="application/octet-stream")]
        ...
        private static function registerPrograms():void
        {
            ...
            var shaderRaw:ByteArray = new SHADER() as ByteArray;
            var programBytes:Array = assembler.getProgramBytesFromString(shaderRaw.toString());
