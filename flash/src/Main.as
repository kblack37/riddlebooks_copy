package
{
    ...
    public class Main extends Sprite
    {
        ...
        private function onRootObjectCreated(event:starling.events.Event, data:Object):void
        {
            if (data is WordProblemGameBase)
            {
                const mainApplication:WordProblemGameBase = data as WordProblemGameBase;
        ...
        private function onResize(event:ResizeEvent):void
        {
            ...
            var DES_WIDTH:Number = 800;
            var DES_HEIGHT:Number = 600;
