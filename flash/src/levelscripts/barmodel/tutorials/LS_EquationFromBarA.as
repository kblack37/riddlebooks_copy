package levelscripts.barmodel.tutorials
{
    ...
    public class LS_EquationFromBarA extends BaseCustomLevelScript
    {
        ...
        private var m_buildOptions:Vector.<String>;
        private var m_materialAOptions:Vector.<String>;
        private var m_materialBOptions:Vector.<String>;
        
        private var m_buildSelected:String;
        private var m_materialASelected:String;
        private var m_materialBSelected:String;
        
        private var m_equationAreasShowing:Boolean = false;
        ...
        public function LS_EquationFromBarA(gameEngine:IGameEngine, 
                                            ...
                                            isActive:Boolean=true)
        {
            ...
            m_buildOptions = Vector.<String>(["cannon", "space_ship", "dinosaur", "teleporter", "box"]);
            m_materialAOptions = Vector.<String>(["sword", "cupcake", "rope", "bunny"]);
            m_materialBOptions = Vector.<String>(["apple", "red_panda", "flowers_pink", "mushroom"]);
        ...
        override public function visit():int
        {
            if (m_ready)
            {
                ...
                {
                    leftTermArea = m_gameEngine.getUiEntity("leftTermArea") as TermAreaWidget;
                    rightTermArea = m_gameEngine.getUiEntity("rightTermArea") as TermAreaWidget;
                    
                    var addedBothNumbers:Boolean = false;
                    addedVariable = false;
        ...
        override protected function onLevelReady():void
        {
            ...
            sequenceSelector.pushChild(new CustomVisitNode(moveUiEntityTo, {id:"deckAndTermContainer", time:0.3, y:300}));
        ...
        override protected function processBufferedEvent(eventType:String, param:Object):void
        {
            if (eventType == GameEvent.BAR_MODEL_CORRECT)
            {
                if (m_progressControl.getProgress() == 0)
                {
                    ...
                    contentA.appendChild(buildName);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["build_select_a"]),
                    ...
                    contentA = <span></span>;
                    contentA.appendChild(buildName);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["build_select_b"]),
                        Vector.<XML>([contentA]), 1);
                    
                    contentA = <span></span>;
                    contentA.appendChild(buildName);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["build_select_c", "build_select_d"]),
                        Vector.<XML>([contentA, contentA]), 2);
                    
                    contentA = <span></span>;
                    contentA.appendChild(buildName);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["build_select_e"]),
                ...
                else if (m_progressControl.getProgress() == 1)
                {
                    ...
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["material_a_select_a"]),
                        Vector.<XML>([contentA]), 1);
                    refreshSecondPage();
                ...
                else if (m_progressControl.getProgress() == 3)
                {
                    ...
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["material_b_select_a", "material_b_select_b"]),
                        Vector.<XML>([contentA, contentA]), 2);
                    refreshThirdPage();
        ...
        private function setupFirstEquation():void
        {
            ...
            m_gameEngine.setDeckAreaContent(new Vector.<String>(), new Vector.<Boolean>(), false);
            ...
            showDialogForUi( { id:"switchModelButton", text:"Click here!", color:0xFFFFFF, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        }
        ...
        private function refreshFirstPage():void
        {
            ...
            if (robotImage == null)
            {
                var robotTexture:Texture = FlashResourceUtil.getTextureFromFlashClass(Robot, {frame:0}, 0.8, new Rectangle(50, 210, 140, 230));
        ...
        private function onSwitchModelClicked(inBarModelMode:Boolean):void
        {
            ...
            else
            {
                ...
                if (m_progressControl.getProgress() == 2)
                {
                    ...
                    showDialogForUi({id:"barModelArea", text:"Pick up pieces!", color:0xFFFFFF, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        ...
        */
        ...
        {
            showDialogForUi( { id:"leftTermArea", text:"Put 9 here!", color:0xFFFFFF, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        }
        ...
        private function showDragVariableA():void
        {
            ...
            showDialogForUi( { id:uiEntityToAddTo, text:"Put " + materialName + " here!", color:0xFFFFFF, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        }
        ...
        {
            showDialogForUi({id:"modelEquationButton", text:"Press when done!", color:0xFFFFFF, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        }
        ...
        {
            showDialogForUi( { id:"leftTermArea", text:"Put 2 numbers here!", color:0xFFFFFF, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        }
