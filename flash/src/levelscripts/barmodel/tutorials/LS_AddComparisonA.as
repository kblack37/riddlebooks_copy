package levelscripts.barmodel.tutorials
{
    ...
    public class LS_AddComparisonA extends BaseCustomLevelScript
    {
        ...
        public function LS_AddComparisonA(gameEngine:IGameEngine, 
                                          ...
                                          isActive:Boolean=true)
        {
            ...
            m_items = Vector.<String>(["watermelon", "fish", "caterpillar", "cookie", "pegasus", "sea_sprite"]);
        ...
        override public function visit():int
        {
            if (m_ready)
            {
                ...
                {
                    var barComparisonFound:Boolean = false;
                    var i:int;
                ...
                {
                    var firstBarAdded:Boolean = false;
                    var secondBarAdded:Boolean = false;
                ...
                else if (m_progressControl.getProgress() == 4)
                {
                    ...
                    var usedSubtract:Boolean = false;
        ...
        override protected function onLevelReady():void
        {
            ...
            sequenceSelector.pushChild(new CustomVisitNode(moveUiEntityTo, {id:"deckAndTermContainer", time:0.3, y:285}));
        ...
        override protected function processBufferedEvent(eventType:String, param:Object):void
        {
            if (eventType == GameEvent.BAR_MODEL_CORRECT)
            {
                ...
                else if (m_progressControl.getProgress() == 2)
                {
                    ...
                    contentA = <span></span>;
                    contentA.appendChild(itemName);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["item_select_d"]),
                        Vector.<XML>([contentA]), 2);
                    
                    contentA = <span></span>;
                    contentA.appendChild(itemName);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["item_select_e", "item_select_f"]),
                        Vector.<XML>([contentA, contentA]), 3);
                    
                    refreshThirdPage();
                    
                    // Reveal last part of the text
                    setDocumentIdVisible({id:"hidden_c", visible:true});
                }
            ...
            else if (eventType == GameEvent.EQUATION_MODEL_SUCCESS)
            {
                if (m_progressControl.getProgress() == 4)
                {
                    ...
                    // Reveal last part of the text
                    setDocumentIdVisible({id:"hidden_d", visible:true});
                }
            }
        }
        ...
        */
        private function setupSecondModel():void
        {
            ...
            var deckItems:Vector.<String> = Vector.<String>(["difference"]);
            ...
            var termToValueMap:Object = {tic_a: 6, tac_a: 3};
            ...
            correctBarWhole.barSegments.push(new BarSegment(termToValueMap["tic_a"], 1, 0, null));
            ...
            correctBarWhole.barSegments.push(new BarSegment(termToValueMap["tac_a"], 1, 0, null));
            ...
            startingBarWhole.barSegments.push(new BarSegment(termToValueMap["tic_a"], 1, 0x69E3C5, null));
            ...
            startingBarWhole.barSegments.push(new BarSegment(termToValueMap["tac_a"], 1, 0x95F2F2, null));
        ...
        */
        private function setupFourthModel():void
        {
            ...
            var deckItems:Vector.<String> = Vector.<String>(["tic_b", "tac_b", "difference"]);
            m_gameEngine.setDeckAreaContent(deckItems, super.getBooleanList(deckItems.length, false), false);
            
            // Manually bind the numeric value for each custom instance
            var termToValueMap:Object = {tic_b: 3, tac_b: 6};
            m_gameEngine.getCurrentLevel().termValueToBarModelValue = termToValueMap;
            ...
            var correctModel:BarModelData = new BarModelData();
            var correctBarWhole:BarWhole = new BarWhole(false, "barA");
            correctBarWhole.barSegments.push(new BarSegment(termToValueMap["tac_b"], 1, 0, null));
            correctBarWhole.barLabels.push(new BarLabel("tac_b", 0, 0, true, false, BarLabel.BRACKET_NONE, null));
            correctModel.barWholes.push(correctBarWhole);
            
            correctBarWhole = new BarWhole(false, "barB");
            correctBarWhole.barSegments.push(new BarSegment(termToValueMap["tic_b"], 1, 0, null));
        ...
        */
        ...
        private function showAddComparison():void
        {
            ...
            showDialogForBaseWidget({
                id:barIdForCallout, widgetId:"barModelArea", text:"Show difference.",
                color:0xFFFFFF, direction:Callout.DIRECTION_DOWN, width:200, height:60, animationPeriod:1, xOffset:300, yOffset:-20
            });
        ...
        private function showAddSecondComparisonHint():void
        {
            ...
            if (targetId != null)
            {
                ...
                showDialogForBaseWidget({
                    id:targetId, widgetId:"barModelArea", text:"Add difference.",
                    color:0xFFFFFF, direction:Callout.DIRECTION_DOWN, width:200, height:60, animationPeriod:1, xOffset:300
                });
            }
        }
        ...
        private function showAddLabel(deckId:String):void
        {
            ...
            showDialogForBaseWidget({
                id:deckId, widgetId:"deckArea", text:"Make New Box",
        ...
        private function showSubtractionHint():void
        {
            ...
            showDialogForBaseWidget({
                ...
                color:0xFFFFFF, direction:Callout.DIRECTION_UP, width:200, xOffset:-90, animationPeriod:1
            });
        }
