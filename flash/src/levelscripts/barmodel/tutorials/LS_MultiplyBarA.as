package levelscripts.barmodel.tutorials
{
    ...
    public class LS_MultiplyBarA extends BaseCustomLevelScript
    {
        ...
        */
        ...
        public function LS_MultiplyBarA(gameEngine:IGameEngine, 
                                        ...
                                        isActive:Boolean=true)
        {
            ...
            m_items = Vector.<String>(["feather", "moon_craft", "buffalo", "balloon_grey", "dog_biscuit"]);
        ...
        override public function visit():int
        {
            if (m_ready)
            {
                ...
                {
                    var groupsCreated:Boolean = false;
                ...
                {
                    groupsCreated = false;
                    var nameOnTopOfSegment:Boolean = false;
                    if (m_barModelArea.getBarWholeViews().length > 0)
                    {
                ...
                else if (m_progressControl.getProgress() == 3 && m_isBarModelSetup)
                {
                    ...
                    var labelUnderneath:Boolean = false;
                    if (m_barModelArea.getBarWholeViews().length > 0)
                    {
                        ...
                        for each (var labelView:BarLabelView in labelViews)
                        {
                ...
                {
                    var changedToMultiply:Boolean = false;
        ...
        override protected function processBufferedEvent(eventType:String, param:Object):void
        {
            if (eventType == GameEvent.BAR_MODEL_CORRECT)
            {
                if (m_progressControl.getProgress() == 0)
                {
                    ...
                    contentA.appendChild(itemNameSingle);
                    ...
                    contentA = <span></span>;
                    contentA.appendChild(itemNameSingle);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["item_select_d", "item_select_e"]),
                        Vector.<XML>([contentA, contentA]), 2);
                    
                    contentA = <span></span>;
                    contentA.appendChild(itemNameSingle);
                    m_textReplacementControl.replaceContentAtDocumentIdsAtPageIndex(Vector.<String>(["item_select_f", "item_select_g", "item_select_h"]),
        ...
        {
            var deckItems:Vector.<String> = Vector.<String>(["3"]);
        ...
        {
            var deckItems:Vector.<String> = Vector.<String>(["3", "4"]);
            m_gameEngine.setDeckAreaContent(deckItems, super.getBooleanList(deckItems.length, false), false);
        ...
        private function setupBarModelC():void
        {
            ...
            var deckItems:Vector.<String> = Vector.<String>(["4", "5", "total"]);
            m_gameEngine.setDeckAreaContent(deckItems, super.getBooleanList(deckItems.length, false), false);
        ...
        */
        ...
        private function showCreateGroups():void
        {
            ...
            showDialogForUi({
                id:"barModelArea", text:"Make equal groups.",
                color:0xFFFFFF, direction:Callout.DIRECTION_UP, width:70, height:100, animationPeriod:1, xOffset:xOffset, yOffset:yOffset
            });
        }
        ...
        private function showDragOnTop():void
        {
            ...
            if (m_barModelArea.getBarWholeViews().length > 0)
            {
                var segmentViews:Vector.<BarSegmentView> = m_barModelArea.getBarWholeViews()[0].segmentViews;
            ...
            if (id != null)
            {
                ...
                showDialogForBaseWidget({
                    id:id, widgetId:"barModelArea", text:"Drag on top of box to add name.",
                    color:0xFFFFFF, direction:Callout.DIRECTION_UP, width:200, height:70, animationPeriod:1, xOffset:0
                });
                m_pickedId = id;
            }
        }
        ...
        private function showDragUnder():void
        {
            ...
            if (id != null)
            {
                m_barModelArea.addOrRefreshViewFromId(id);
                showDialogForBaseWidget({
                    id:id, widgetId:"barModelArea", text:"Drag here to name ALL groups.",
        ...
        private function showClickToMultiply():void
        {
            ...
            showDialogForBaseWidget({
                ...
                color:0xFFFFFF, direction:Callout.DIRECTION_UP, width:200, height:70, xOffset:-40, animationPeriod:1
            });
