package levelscripts.barmodel.tutorialsv2
{
    ...
    public class IntroCreateEquation extends BaseCustomLevelScript
    {
        ...
        private var m_jobToTotalMapping:Object = {
            ninja: {total_a_name: "guards snuck past", total_a_abbr: "total guards", total_b_name: "total rooms counted", total_b_abbr: "rooms"},
            zombie: {total_a_name: "", total_a_abbr: "", total_b_name: "", total_b_abbr: ""},
            basketball: {total_a_name: "shots made", total_a_abbr: "total made shots", total_b_name: "total turnovers", total_b_abbr: "turnovers"},
            fairy: {total_a_name: "travelers lured", total_a_abbr: "total travelers", total_b_name: "total chirps made", total_b_abbr: "chirps"},
            superhero: {total_a_name: "villians battled", total_a_abbr: "total villians", total_b_name: "", total_b_abbr: ""}
        };
         ...
         */
        private var m_targetNumbersActive:Vector.<String>;
        private var m_expressionNodeBuffer:Vector.<ExpressionNode>;
        
        public function IntroCreateEquation(gameEngine:IGameEngine, 
        ...
        override protected function onLevelReady():void
        {
            ...
            var numbersToAdd:Vector.<int> = new Vector.<int>();
            numbersToAdd.push(7, 9);
            ...
            m_targetNumbersActive = new Vector.<String>();
            
            var existingModel:BarModelData = new BarModelData();
            var barWhole:BarWhole = new BarWhole(false);
            for (var i:int = 0; i < numbersToAdd.length; i++)
            {
                var numberToAdd:int = numbersToAdd[i];
                m_targetNumbersActive.push(numberToAdd.toString());
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                ...
                {
                    setDocumentIdVisible({id:"part_a_question", visible:true, pageIndex:0});
                    return ScriptStatus.SUCCESS;
                }, null));
            
            sequenceSelector.pushChild(new CustomVisitNode(secondsElapsed, {duration:0.5}));
            sequenceSelector.pushChild(new CustomVisitNode(clickToContinue, {x:450, y:290}));
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    showDialogForUi( { id:"switchModelButton", text:"Click here!", height:50, color:0x5082B9, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
            ...
            sequenceSelector.pushChild(new CustomVisitNode(moveUiEntityTo, {id:"deckAndTermContainer", time:0.4, y:650}));
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    var docIdsForNumbers:Vector.<String> = Vector.<String>(["number_a", "number_b"]);
            ...
            sequenceSelector.pushChild(new CustomVisitNode(secondsElapsed, {duration:0.8}));
            sequenceSelector.pushChild(new CustomVisitNode(clickToContinue, {x:450, y:250}));
            sequenceSelector.pushChild(new CustomVisitNode(moveUiEntityTo, {id:"deckAndTermContainer", time:0.3, y:slideUpPositionY}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    m_switchModelScript.setIsActive(true);
                    showDialogForUi( { id:"switchModelButton", text:"Click here!", color:0x5082B9, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
        ...
        private function onSwitchModelClicked(inBarModelMode:Boolean):void
        {
            ...
            else
            {
                ...
                if (m_progressControl.getProgressValueEquals("stage", "start"))
                {
                    ...
                    showDialogForUi({id:"barModelArea", text:"Pick up pieces!", color:0x5082B9, direction:Callout.DIRECTION_UP, animationPeriod:1 } );
                }
                else if (m_progressControl.getProgressValueEquals("stage", "partb_barmodel_finished"))
                {
                    removeDialogForUi({id:"switchModelButton"});
