package levelscripts.barmodel.tutorialsv2
{
    ...
    public class IntroMultiplication extends BaseCustomLevelScript
    {
        ...
        private var m_jobToTotalMapping:Object = {
            ninja: {
                total_a_name: "total ninjas", total_a_abbr: "total ninjas", total_b_name: "total scouts", total_b_abbr: "scouts",
                numeric_unit_group: "groups", numeric_unit_unit_a: "ninjas", numeric_unit_unit_b: "scouts"
            },
            zombie: {
                total_a_name: "total zombies", total_a_abbr: "total zombies", total_b_name: "total siege zombies", total_b_abbr: "siege zombies",
                numeric_unit_group: "groups", numeric_unit_unit_a: "zombies", numeric_unit_unit_b: "siege"
            },
            basketball: {
                total_a_name: "total players", total_a_abbr: "total players", total_b_name: "total coaches", total_b_abbr: "coaches",
                numeric_unit_group: "teams", numeric_unit_unit_a: "players", numeric_unit_unit_b: "coaches"
            },
            fairy: {
                total_a_name: "total fairies", total_a_abbr: "total fairies", total_b_name: "total light bearers", total_b_abbr: "light bearers",
                numeric_unit_group: "groups", numeric_unit_unit_a: "fairies", numeric_unit_unit_b: "bearers"
            },
            superhero: {
                total_a_name: "total heroes", total_a_abbr: "total heroes", total_b_name: "total elite heroes", total_b_abbr: "elite heroes",
                numeric_unit_group: "teams", numeric_unit_unit_a: "heroes", numeric_unit_unit_b: "elite"
            }
        };
        
        public function IntroMultiplication(gameEngine:IGameEngine, 
        ...
        override public function visit():int
        {
            if (m_ready)
            {
                ...
                {
                    var addedBracket:Boolean = false;
                    firstBarWhole = m_barModelArea.getBarModelData().barWholes[0];
                    for each (var barLabel:BarLabel in firstBarWhole.barLabels)
                    {
                ...
                else if (m_progressControl.getProgressValueEquals("hinting", "replace_box"))
                {
                    ...
                    var oldMultiplicandPresent:Boolean = false;
                    var newMultiplicandPresent:Boolean = false;
                    firstBarWhole = m_barModelArea.getBarModelData().barWholes[0];
                    for each (barLabel in firstBarWhole.barLabels)
                    {
                ...
                else if (m_progressControl.getProgressValueEquals("hinting", "add_multiply_operator"))
                {
                    ...
                    var addedMultiplication:Boolean = false;
        ...
        override protected function onLevelReady():void
        {
            ...
            sequenceSelector.pushChild(new CustomVisitNode(secondsElapsed, {duration:0.3}));
            sequenceSelector.pushChild(new CustomVisitNode(clickToContinue, {x:450, y:270}));
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    setDocumentIdsSelectable(Vector.<String>([multiplierDocId]), true, 0);
                    ...
                    dataForCard.abbreviatedName = multiplicand + " " + m_jobToTotalMapping[selectedPlayerJob].numeric_unit_unit_a;
                    dataForCard = m_gameEngine.getExpressionSymbolResources().getSymbolDataFromValue(multiplier);
                    dataForCard.abbreviatedName = multiplier + " " + m_jobToTotalMapping[selectedPlayerJob].numeric_unit_group;
            ...
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"hinting", value:"use_multiply_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    (getNodeById("RestrictCardsInBarModel") as RestrictCardsInBarModel).setTermValuesManuallyDisabled(Vector.<String>([m_firstMultiplier]));
                    ...
                    setDocumentIdsSelectable(Vector.<String>([totalDocId]), true, 0);
                    
                    m_progressControl.setProgressValue("hinting", "add_total");
                    return ScriptStatus.SUCCESS;
                }, null));
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"hinting", value:"add_total_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    setDocumentIdsSelectable(Vector.<String>([multiplicandDocId]), true, 1);
                    ...
                    var dataForCard:SymbolData = m_gameEngine.getExpressionSymbolResources().getSymbolDataFromValue(multiplicand);
                    dataForCard.abbreviatedName = multiplicand + " " + m_jobToTotalMapping[selectedPlayerJob].numeric_unit_unit_b;
                    ...
                    addNewLabelOnSegment.setRestrictedElementIdsCanPerformAction(Vector.<String>([targetSegmentId]));
            ...
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"hinting", value:"replace_box_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    m_validateBarModel.setIsActive(true);
            ...
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"stage", value:"partb_barmodel_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    (m_gameEngine.getUiEntity("leftTermArea") as TermAreaWidget).isInteractable = false;
            ...
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"hinting", value:"add_multiply_operator_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
            ...
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"stage", value:"partb_equation_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
        ...
        */
        ...
        private function showMultiply():void
        {
            ...
            showDialogForUi({
                id:"barModelArea", text:"Drag number to multiply",
                color:CALLOUT_TEXT_DEFAULT_COLOR, direction:Callout.DIRECTION_UP, width:120, height:80, animationPeriod:1, xOffset:xOffset, yOffset:yOffset
            });
        ...
        private function showAddTotal():void
        {
            ...
            if (id != null)
            {
                ...
                showDialogForBaseWidget({
                    id:id, widgetId:"barModelArea", text:"Show the total of all boxes.",
                    color:CALLOUT_TEXT_DEFAULT_COLOR, direction:Callout.DIRECTION_DOWN, width:150, height:70, animationPeriod:1, xOffset:0, yOffset: 40
                });
                m_pickedId = id;
            }
        ...
        private function showReplaceBox():void
        {
            ...
            if (id != null)
            {
                m_barModelArea.addOrRefreshViewFromId(id);
                showDialogForBaseWidget({
                    id:id, widgetId:"barModelArea", text:"Change the group to the right number.",
                    color:CALLOUT_TEXT_DEFAULT_COLOR, direction:Callout.DIRECTION_UP, width:200, height:70, animationPeriod:1, xOffset:0
                });
        ...
        private function showMultiplyOperator():void
        {
            ...
            if (targetSourceSegment != null)
            {
                ...
                showDialogForBaseWidget({
                    id:targetSourceSegment, widgetId:"barModelArea", text:"Drag number here...",
                    color:CALLOUT_TEXT_DEFAULT_COLOR, direction:Callout.DIRECTION_DOWN, width:200, height:60, animationPeriod:1, xOffset:0
                });
                ...
                showDialogForBaseWidget({
                    id:multiplyTermId, widgetId:"rightTermArea", text:multiplyTermText, 
                    color:CALLOUT_TEXT_DEFAULT_COLOR, direction:Callout.DIRECTION_UP, width:200, height:70, xOffset:0, animationPeriod:1
                });
        ...
        {
            removeDialogForBaseWidget({id:m_targetSegmentId, widgetId:"barModelArea"});
            removeDialogForBaseWidget({id:m_pickedId, widgetId:"rightTermArea"});
        }
    }
}