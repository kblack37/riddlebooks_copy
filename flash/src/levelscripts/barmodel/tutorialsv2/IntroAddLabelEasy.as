package levelscripts.barmodel.tutorialsv2
{
     ...
     */
    public class IntroAddLabelEasy extends BaseCustomLevelScript
    {
        ...
        public function IntroAddLabelEasy(gameEngine:IGameEngine, 
            ...
            if (m_ready)
            {
                if (m_progressControl.getProgressValueEquals("stage", "add_numbers_single_row"))
                {
                    ...
                    if (barWholes.length > 0)
                    {
                        ...
                        for each (barLabel in targetBarWhole.barLabels)
                        {
        ...
        override protected function onLevelReady():void
        {
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    (param.rootNode as BaseCustomLevelScript).pushChild(new HighlightTextProcess(m_textAreaWidget, 
                        Vector.<String>(["part_a_number_a", "part_a_number_b"]), 0xFF9900, 1, "highlightnumbersfirstpart"));     
                    
                    return ScriptStatus.SUCCESS;
                }, {rootNode:this}));
            
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"stage", value:"add_bracket_single_row"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    (param.rootNode as BaseCustomLevelScript).deleteChild(getNodeById("highlightnumbersfirstpart"));
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    setDocumentIdVisible({id:"new_add_method", visible:true, pageIndex:1});
                    return ScriptStatus.SUCCESS;
                }, null));
            ...
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    ...
                    (getNodeById("AddNewBar") as AddNewBar).setMaxBarsAllowed(2);
            ...
            sequenceSelector.pushChild(new CustomVisitNode(m_progressControl.getProgressValueEqualsCallback, {key:"stage", value:"partb_finished"}));
            sequenceSelector.pushChild(new CustomVisitNode(
                function(param:Object):int
                {
                    getNodeById("barmodelgestures").setIsActive(false);
        ...
        */
        ...
        {
            showDialogForUi({
                id:"barModelArea", text:"Add a number here!",
                color:0x5082B9, direction:Callout.DIRECTION_DOWN, width:150, height:50, animationPeriod:1, yOffset:-160
            });
        }
        ...
        private function showAddNumbersInOneRow():void
        {
            ...
            if (id != null)
            {
                ...
                showDialogForBaseWidget({
                    id:id, widgetId:"barModelArea", text:"Put other number here to add.",
        ...
        private function showAddHorizontalBracket():void
        {
            if (m_barModelArea.getBarWholeViews().length > 0 && m_barModelArea.getBarWholeViews()[0].segmentViews.length > 0)
            {
                ...
                showDialogForBaseWidget({
                    id:targetSegmentId, widgetId:"barModelArea", text:"Put the total here.",
