package wordproblem.event
{
    public class CommandEvent
    {
         ...
         */
        public static const GO_TO_LEVEL:String = "go_to_level";
         ...
         */
        public static const GO_TO_NEXT_LEVEL:String = "go_to_next_level";
         ...
         */
        public static const LEVEL_QUIT_BEFORE_COMPLETION:String = "level_quit";
         ...
         */
        public static const LEVEL_QUIT_AFTER_COMPLETION:String = "level_quit_after_completion";
         ...
         */
        public static const LEVEL_RESTART:String = "level_reset";
         ...
         */
        public static const LEVEL_SKIP:String = "level_skipped";
         ...
         */
        public static const USER_AUTHENTICATED:String = "user_authenticated";
         ...
         */
        public static const WAIT_SHOW:String = "wait_show";
         ...
         */
        public static const WAIT_HIDE:String = "wait_hide";
         ...
         * create screen.
         */
        public static const SHOW_ACCOUNT_CREATE:String = "show_account_create";
        
        /**
         * Go to the screen showing player stats and the items they have collected
         */
        public static const GO_TO_PLAYER_COLLECTIONS:String = "go_to_player_collections";
         ...
         */
        public static const LEVEL_PROGRESS_SAVE_UPLOADED:String = "level_progress_save_uploaded";
         ...
         */
        public static const LEVEL_PROGRESS_SAVE_UPDATED:String = "level_progress_save_updated";
    }
}