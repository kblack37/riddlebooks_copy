package wordproblem.level.nodes
{
     ...
     */
    public class GenreLevelPack extends WordProblemLevelPack
    {
        public static const NODE_TYPE:String = "GenreLevelPack";
        
        public function GenreLevelPack(levelManager:ICgsLevelManager, cache:ICgsUserCache, levelFactory:ICgsLevelFactory, lockFactory:ICgsLockFactory, nodeLabel:int)
        {
