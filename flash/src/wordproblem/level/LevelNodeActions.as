package wordproblem.level
{
    ...
    public class LevelNodeActions
    {
         ...
         */
        public static const SET_NODE_COMPLETE:String = "SetNodeComplete";
        
        /**
         * params:
         * name-String name of node
         */
        public static const SET_NODE_AVAILABLE:String = "SetNodeAvailable";
         ...
         */
        public static const SET_MASTERY:String = "SetMastery";
        
        /**
         * Pick a random level at the the current node that had the edge going into it.
         */
        public static const PICK_RANDOM_UNCOMPLETED_LEVEL:String = "PickRandomUncompletedLevel";
        
        /**
         * Treating levels as a linear sequence pick the first one in the list that is not completed
         * and not locked.
         */
        public static const PICK_FIRST_UNCOMPLETED_LEVEL:String = "PickFirstUncompletedLevel";
        
        /**
         * Treating levels as a linear sequence pick the first one regardless of completion value.
         */
        public static const PICK_FIRST_LEVEL:String = "PickFirstLevel";
         ...
         */
        public static const PICK_NEXT_IN_SET:String = "PickNextInSet";
         ...
         */
        public static const CLEAR_CONDITIONS_FOR_EDGE:String = "ClearConditionsForEdge";
         ...
         */
        public static const CLEAR_PERFORMANCE_STATE_FOR_NODE:String = "ClearPerformanceStateForNode";
    }
}