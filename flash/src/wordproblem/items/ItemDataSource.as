package wordproblem.items
{
     ...
     * the game.
     */
    public class ItemDataSource extends ComponentManager
    {
        /**
         * @param rawData
         *      An array of json formatted objects describing items
         */
        public function ItemDataSource(rawData:Object)
        {
            ...
            const componentFactory:ComponentFactory = new ComponentFactory(new LatexCompiler(new RealsVectorSpace()));
