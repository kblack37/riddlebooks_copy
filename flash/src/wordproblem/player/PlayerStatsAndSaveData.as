package wordproblem.player
{
     ...
     */
    public class PlayerStatsAndSaveData
    {
        /**
         ...
         */
        private static const DECISIONS_SAVE_KEY:String = "decisions";
        
        /**
         * Key to the registration name of the cursor last equipped by the user
         */
        private static const CURSOR_SAVE_KEY:String = "cursor";
        
        /**
         * Key to the button color name equipped by the user
         */
        private static const BUTTON_COLOR_SAVE_KEY:String = "button_color";
         ...
         */
        private static const ENABLE_HINTS_ON_MISTAKES_KEY:String = "hints";
        
        /**
         * Keep track of whether the next level the player attempts to play should
         * have a partially completed model.
         */
        private static const PARTIAL_BAR_COMPLETION_KEY:String = "partial_bar";
         ...
         */
        private var m_playerDecisions:Object;
        ...
        private var m_enableHintsOnMistakes:Boolean;
         ...
         */
        public var useCustomHints:Boolean = true;
         ...
         */
        public var useAiHints:Boolean = false;
         ...
         */
        public function PlayerStatsAndSaveData(cache:ICgsUserCache, 
                                               defaultPlayerDecisions:Object=null)
        {
            m_cache = cache;
            ...
            {
                for (var decisionKey:String in defaultPlayerDecisions)
                {
                    if (!m_playerDecisions.hasOwnProperty(decisionKey))
                    {
                        m_playerDecisions[decisionKey] = defaultPlayerDecisions[decisionKey];
                    }
                }
            }
        }
         ...
         * to change to she
         */
        public function setPlayerDecision(property:String, value:Object):void
        {
            m_playerDecisions[property] = value;
         ...
         */
        public function getPlayerDecision(property:String):Object
        {
            return m_playerDecisions[property];
        }
        ...
        public function setEnableHintsOnMistake(value:Boolean):void
        {
        ...
        public function getEnableHintsOnMistake():Boolean
        {
