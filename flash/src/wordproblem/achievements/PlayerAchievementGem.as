package wordproblem.achievements
{
     ...
     */
    public class PlayerAchievementGem extends Sprite
    {
        ...
        public function PlayerAchievementGem(colorName:String,
                                             trophyName:String,
                                             isFilledInitially:Boolean, 
                                             assetManager:AssetManager)
        {
            ...
            var fillXOffset:Number = 0;
            var fillYOffset:Number = 0;
            if (colorName == "Blue")
            {
                fillYOffset = -1.5;
            }
         ...
         */
        public function startFillAnimation(duration:Number, onComplete:Function):void
        {
            ...
            centerShrink.onComplete = function():void
            {
                ...
                var expandDuration:Number = duration * 0.5;
