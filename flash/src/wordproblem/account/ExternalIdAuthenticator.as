package wordproblem.account
{
     ...
     */
    public class ExternalIdAuthenticator
    {
        /**
        ...
        private var m_saveToServer:Boolean;
        ...
        public function ExternalIdAuthenticator(logger:AlgebraAdventureLogger,
                        ...
                        m_logger.getCgsApi().registerStudent(
                            ...
                            function(response:CgsUserResponse):void
                            {
                                if (response.success && response.cgsUser)
                                {
                                    ...
                                    if (m_integrationServiceSuccessCallback)
                                    {
                                ...
                                {
                                    if (m_integrationServiceFailCallback)
                                    {
