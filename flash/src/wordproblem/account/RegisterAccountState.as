package wordproblem.account
{
     ...
     */
    public class RegisterAccountState extends Sprite implements IDisposable
    {
        ...
        public function RegisterAccountState(anonymousUser:ICgsUser,
                                             ...
                                             descriptionText:String=null)
        {
                                                                            ...
                                                                            registerFailMessage:TextField):void
            {
                ...
                var labelHorizontalLine:Number = 265;
                userNameLabel.x = labelHorizontalLine;
                userNameLabel.y = 120;
                m_registerAccountScreen.addChild(userNameLabel);
                
                var inputHorizontalLine:Number = userNameLabel.x + userNameLabel.width;
        ...
        private function onRegisterSuccess(user:ICgsUser):void
        {
            ...
            function tosAccepted():void
            {
                ...
                {
                    var animation:MovieClip = new MovieClip();//new Art_PrizeFishBowl();
                    animation.stop();
                    return animation;
                };
                                                                               ...
                                                                               okButton:Button):void
                {
                    ...
                    Starling.juggler.delayCall(function():void
                    {
                        ...
                        Starling.juggler.delayCall(function():void
                        {
                            ...
                            var desciptionTween:Tween = new Tween(descriptionText, 1);
                            desciptionTween.fadeTo(1.0);
                            Starling.juggler.add(desciptionTween);
                            m_registerRewardScreen.addChild(descriptionText);
                            
                            okButton.alpha = 0.0;
                            var buttonTween:Tween = new Tween(okButton, 1);
                            buttonTween.fadeTo(1.0);
