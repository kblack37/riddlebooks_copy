package wordproblem.state
{
     ...
     * the animations)
     */
    public class WordProblemSelectState extends BaseState
    {
         ...
         */
        private var m_cachedDataObjectsForLevelSelect:Vector.<Object>;
        ...
        public function WordProblemSelectState(stateMachine:IStateMachine,
        ...
        override public function enter(fromState:Object, params:Vector.<Object>=null):void
        {
            ...
            m_cachedDataObjectsForLevelSelect = new Vector.<Object>();
            
            // Grab all the genre nodes, this will help us define all the clickable areas
            var outGenreNodes:Vector.<GenreLevelPack> = new Vector.<GenreLevelPack>();
            ...
            var sectionsInLevelSelect:Array = levelSelectConfig.sections;
            var numSections:int = sectionsInLevelSelect.length;
            for each (var sectionInLevelSelect:Object in sectionsInLevelSelect)
            {
                var cachedObjectForSection:Object = {};
                
                // If genre is locked it should not be clickable
                var hitAreaData:Object = sectionInLevelSelect.hitArea;
                ...
                if (sectionInLevelSelect.hasOwnProperty("hoverTextArea"))
                {
                    var textAreaRectangle:Object = sectionInLevelSelect.hoverTextArea;
                    var hoverTextField:TextField = new TextField(
                        ...
                        (textAreaRectangle.hasOwnProperty("fontSize")) ? textAreaRectangle.fontSize : 32,
                        0xFFFFFF
                    );
                ...
                for each (var playableGenreLevels:GenreLevelPack in outGenreNodes)
                {
            ...
            var optionNames:Vector.<String> = Vector.<String>([OptionsWidget.OPTION_MUSIC, OptionsWidget.OPTION_SFX, OptionsWidget.OPTION_CREDITS]);
            ...
            m_logoutWidget.y = 0;
            var flashToStarlingScale:Number = Starling.current.viewPort.width / m_flashStage.width;
            ...
            {
                var openGenreWidgetData:Object = params[0];
                ...
                if (openGenreWidgetData.hasOwnProperty("levelIndex") && m_currentGenreWidget != null)
                {
                    m_currentGenreWidget.setGenre(genreNode as GenreLevelPack, chapterIndex);
        ...
        override public function exit(toState:Object):void
        {
            ...
            var i:int;
            for (i = 0; i < m_cachedDataObjectsForLevelSelect.length; i++)
            {
                var bgImage:Image = m_cachedDataObjectsForLevelSelect[i].hoverBackgroundImage as Image;
                bgImage.dispose();
            }
        ...
        override public function update(time:Time, mouseState:MouseState):void
        {
            ...
            if (m_currentGenreWidget.parent == null)
            {
                ...
                var hitAnArea:Boolean = false;
                for (i = 0; i < m_cachedDataObjectsForLevelSelect.length; i++)
                {
                    var cachedDataForSection:Object = m_cachedDataObjectsForLevelSelect[i];
                    hitArea = cachedDataForSection.hitArea;
                    
                    var selectedGenre:GenreLevelPack = (cachedDataForSection.hasOwnProperty("genreNode")) ?
