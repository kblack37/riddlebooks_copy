package wordproblem.state
{
    ...
    public class TitleScreenState extends BaseState
    {
        ...
        */
         ...
         */
        private var m_autoLogin:Boolean;
        ...
        */
         ...
         */
        private var m_flashStageObjects:Array;
        ...
        */
         ...
         */
        public function TitleScreenState(stateMachine:IStateMachine,
        ...
        override public function enter(fromState:Object, params:Vector.<Object>=null):void
        {
            ...
            var optionsWidget:OptionsWidget = new OptionsWidget(
                ...
                function():void
                {
                    ...
                    var i:int;
                    for (i = 0; i < m_flashStageObjects.length; i++)
                    {
        ...
        override public function exit(toState:Object):void
        {
            ...
            for each (var flashStageObject:DisplayObject in m_flashStageObjects)
            {
            ...
            var i:int;
            const components:int = renderComponents.length;
        ...
        private function showLoginPopup():void
        {
                                             ...
                                             passwordEnabled:Boolean):void
            {
                ...
                var userNameY:Number = titleText.y + 30;
