package wordproblem.engine.barmodel.model
{
    ...
    public class BarLabel
    {
         ...
         */
        public static const BRACKET_NONE:String = "none";
        
        /**
         * A bracket with straight edges
         */
        public static const BRACKET_STRAIGHT:String = "straight";
         ...
         */
        public var isAboveSegment:Boolean;
        ...
        public function BarLabel(value:String,
