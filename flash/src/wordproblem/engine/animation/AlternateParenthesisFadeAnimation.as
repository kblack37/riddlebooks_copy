package wordproblem.engine.animation
{
    ...
    public class AlternateParenthesisFadeAnimation implements IDisposable
    {
        private var m_fadeLeftParenthesisTween:Tween;
        private var m_fadeRightParenthesisTween:Tween;
        
        private var m_fadeDuration:Number = 1.0;
        private var m_leftParenthesis:DisplayObject;
        private var m_leftParenthesisArgs:Array;
        private var m_rightParenthesis:DisplayObject;
        private var m_rightParenthesisArgs:Array;
        
        public function AlternateParenthesisFadeAnimation(leftParenthesis:DisplayObject, 
