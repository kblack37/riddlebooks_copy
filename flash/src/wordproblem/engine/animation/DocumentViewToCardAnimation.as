package wordproblem.engine.animation
{
     ...
     * 
     */
    public class DocumentViewToCardAnimation extends Sprite
    {
        /**
        ...
        public function DocumentViewToCardAnimation(expressionSymbolMap:ExpressionSymbolMap, 
        ...
        public function reset():void
        {
            if (this.viewCopy != null)
            {
                ...
                if (this.viewCopy is Image)
                {
                    (this.viewCopy as Image).texture.dispose();
                }
            }
                                ...
                                onAnimationComplete:Function):void
        {
            ...
            const localPoint:Point = originalView.globalToLocal(mousePoint);
            const drawnCopy:DisplayObject = TextureUtil.getImageFromDisplayObject(originalView);
            ...
            if (attachedExpression != null)
            {
                ...
                textShrinkTween.onComplete = function():void
                {
                    ...
                    (drawnCopy as Image).texture.dispose();
