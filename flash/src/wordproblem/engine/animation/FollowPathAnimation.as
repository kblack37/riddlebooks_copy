package wordproblem.engine.animation
{
     ...
     */
    public class FollowPathAnimation extends EventDispatcher implements IAnimatable
    {
        ...
        private var m_maxTimeSeconds:Number;
        private var m_timeElapsedSeconds:Number;
         ...
         *      stop on its own
         */
        public function FollowPathAnimation(assetManager:AssetManager, 
                                            ...
                                            onComplete:Function=null)
        {
            ...
            const steadyClock:Clock = new SteadyClock(20);
            ...
            const destinationBlendMode:String = Context3DBlendFactor.ONE;
            const renderer:ParticleRenderer = new ParticleRenderer(sourceTexture, sourceBlendMode, destinationBlendMode);
