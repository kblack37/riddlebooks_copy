package wordproblem.engine.animation
{
     ...
     */
    public class ShatterAnimation implements IAnimatable
    {
         ...
         */
        private var m_shatterDuration:Number;
        private var m_totalTimeElapsedSincePlay:Number = 0;
        ...
        public function ShatterAnimation(renderTexture:Texture, 
                                         ...
                                         maxDurationSeconds:Number)
        {
            ...
            var drawnObjectWidth:Number = renderTexture.width;
            var drawnObjectHeight:Number = renderTexture.height;
        ...
        public function play(canvasToAddTo:DisplayObjectContainer, x:Number, y:Number, juggler:Juggler=null):void
        {
            if (juggler == null)
            {
