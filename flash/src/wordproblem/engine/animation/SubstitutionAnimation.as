package wordproblem.engine.animation
{
    ...
    public class SubstitutionAnimation
    {        
        ...
        public function SubstitutionAnimation(widgetToReplace:BaseTermWidget, 
        ...
        private function animateSubstitution():void
        {
            ...
            const expandToBurstDuration:Number = 0.3;
            ...
            const replacementWidget:ExpressionTreeWidget = new ExpressionTreeWidget(
            ...
            const replacementWidgetRoot:DisplayObject = replacementWidget.getWidgetRoot();
            const targetScale:Number = m_previewTree.getWidgetRoot().scaleX;
            
            function onExpandToBurst(tween:GTween):void
            {
                m_widgetToReplace.visible = false;
                
                const replacementInPreview:BaseTermWidget = m_previewTree.getWidgetFromNodeId(m_subtreeToReplace.id);
                const positionOfReplacementPreview:Vector3D = replacementInPreview.getNode().position;
            ...
            function onExpandComplete(tween:GTween):void
            {
                ...
                if (replacementWidgetRoot.parent != null)
                    replacementWidgetRoot.parent.removeChild(replacementWidgetRoot);
