package wordproblem.engine.widget
{
     ...
     */
    public class ConfirmationWidget extends Layer
    {
         ...
         *      than a confirmation
         */
        public function ConfirmationWidget(width:Number, 
                                           height:Number, 
                                           ...
                                           isNotification:Boolean=false)
        {
            ...
            var backgroundWidth:Number = width * 0.5;
            var backgroundHeight:Number = height * 0.5;
            ...
            var combinedButtonWidth:Number = (isNotification) ? buttonWidth : buttonWidth * 2 + 30;
