package wordproblem.engine.objectives
{
     ...
     */
    public class BaseObjective implements IDisposable
    {
        /**
         ...
         */
        public var useInSummary:Boolean;
         ...
         */
        protected var m_grade:int;
        
        public function BaseObjective(type:String,
         ...
         * data to parse.
         */
        public function deserializeFromXml(element:XML):void
        {
            if (element.hasOwnProperty("@useInSummary"))
            {
                this.useInSummary = (element.@useInSummary == "true");
            }
        }
         ...
         * data to parse.
         */
        public function deserializeFromJson(data:Object):void
        {
            if (data.hasOwnProperty("useInSummary"))
            {
