package wordproblem.engine
{
     ...
     * 
	 */
	public interface IGameEngine extends ISprite
	{
         ...
         */
        function getUiEntitiesByClass(classDefinition:Class, outObjects:Vector.<DisplayObject>=null):Vector.<DisplayObject>;
         ...
         */
        function addTermToDocument(termValue:String, documentId:String):Boolean;
         ...
         */
        function setDeckAreaContent(content:Vector.<String>, hidden:Vector.<Boolean>, attemptMergeSymbols:Boolean):Boolean;
         ...
         */
        function setWidgetVisible(id:String, visible:Boolean):Boolean;
         ...
         *      True if the action successfully completed.
         */
        function getTermAreaContent(ids:Vector.<String>, outNodes:Vector.<ExpressionNode>):Boolean;
         ...
         *      True if the action successfully completed
         */
        function setTermAreaContent(termAreaIds:String, content:String):Boolean;
