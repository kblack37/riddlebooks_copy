package wordproblem.currency
{
     ...
     */
    public class CurrencyAwardedAnimation extends Sprite
    {
        ...
        public function CurrencyAwardedAnimation(amountAwarded:int,
                                                 ...
                                                 juggler:Juggler)
        {
            ...
            var coinDesiredEndDimension:Number = 60;
        ...
        override public function dispose():void
        {
            ...
            for each (var tween:Tween in m_tweens)
            {
