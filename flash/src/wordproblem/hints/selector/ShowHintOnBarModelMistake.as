package wordproblem.hints.selector
{
    ...
    public class ShowHintOnBarModelMistake extends HintSelectorNode
    {
         ...
         */
        private var m_firstNoActionHintShown:Boolean;
        ...
        public static const SAVE_KEY_SHOW_HINT_SAVED_COUNTERS:String = "show_hint_saved_counters";
        
        // Save the counters that are used to pick different hints in a level
        private function saveTempHintState():void
        {
            var saveDataCounters:Object = {
        ...
        {
            var saveCounters:Object = m_playerStatsAndSaveData.getPlayerDecision(SAVE_KEY_SHOW_HINT_SAVED_COUNTERS);
        ...
        public static function getDocumentIdToExpressionMap(textArea:TextAreaWidget):Object
        {
		...
		*/
                                                        ...
                                                        userDecomposedModel:DecomposedBarModelData):Object
        {
            ...
            if (barModelType == BarModelTypes.TYPE_1A)
            {
                ...
                mistmatchData = validatePartsAddToSum(m_documentIdToExpressionMap["unk"], userDecomposedModel);
            }
            else if (barModelType == BarModelTypes.TYPE_1B || barModelType == BarModelTypes.TYPE_2E)
            {
                ...
                /*
                // This also can be treated as a difference
                var sumValue:String = m_documentIdToExpressionMap["b1"];
                if (isSumRepresentedAsBox(sumValue, userBarModelData))
                {
                    mistmatchData = validateDifferenceBetweenParts("b", "a", m_documentIdToExpressionMap["unk"], userBarModelData, userDecomposedModel);
                }
                else
                {
                    mistmatchData = validatePartsAddToSum(sumValue, userDecomposedModel);
                }
                */
            }
                                               ...
                                               userDecomposedModel:DecomposedBarModelData):Object
        {
            ...
            if (missingLabelInSum != null && mismatchData == null)
            {
                ...
                var filterData:Object = {existingLabelParts: docIdsExistingAsPartOfSum};
