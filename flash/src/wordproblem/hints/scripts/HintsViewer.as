package wordproblem.hints.scripts
{
     ...
     */
    public class HintsViewer extends ScriptNode implements IShowableScript
    {
        private const NO_HINTS_AVAILABLE:String = "Sorry, I don't have any help right now!";
        private const NO_HINTS_UNLOCKED:String = "Click the button below to ask for help!";
         ...
         */
        private var m_availableHints:Vector.<HintScript>;
        
        private var m_lockedHints:Vector.<HintScript>;
        
        private var m_unlockedHints:Vector.<HintScript>;
        ...
        */
        ...
        private var m_thoughtBubbleWidth:Number = 510;
        private var m_thoughtBubbleHeight:Number = 330;
        ...
        */
        ...
        public function HintsViewer(gameEngine:IGameEngine,
                                    ...
                                    isActive:Boolean=true)
        {
            ...
            m_height = height;
            m_canvas = canvas;
            m_lockedHints = new Vector.<HintScript>();
            m_unlockedHints = new Vector.<HintScript>();
            ...
            var lightbulbIconMaxHeight:Number = 60;
        ...
        public function show():void
        {
            ...
            var targetCharacterHeight:Number = 130;
            ...
            m_lockedHints.length = 0;
            m_unlockedHints.length = 0;
            
            var i:int;
            for (i = 0; i < m_availableHints.length; i++)
            {
            ...
            if (m_unlockedHints.length == 0)
            {
                ...
                {
                    var contentWidth:Number = m_thoughtBubbleMain.width * 0.75;
                    var contentHeight:Number = m_thoughtBubbleMain.height * 0.64;
        ...
        private function showHintAtIndex(index:int):void
        {
            ...
            var newHintEnabled:Boolean = false;
            for each (var lockedHint:HintScript in m_lockedHints)
            {
        ...
        private function onNewHintTouched(event:TouchEvent):void
        {
            ...
            var iconToAnimate:DisplayObject = (m_newHintButton.defaultSkin as Sprite).getChildAt(0);
