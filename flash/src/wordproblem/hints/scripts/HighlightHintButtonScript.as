package wordproblem.hints.scripts
{
     ...
     */
    public class HighlightHintButtonScript extends BaseGameScript
    {
        /**
         ...
         */
        private var m_continueCheckingTriggers:Boolean;
        
        /**
         * If the player passes this threshold of seconds between the submission of an answer
         * we assume they are confused.
         */
        private var m_secondsBetweenAnswerSubmit:Number = 180;
        private var m_secondsBetweenAnswerSubmitCounter:Number;
         ...
         */
        private var m_secondsBetweenModification:Number = 90;
        private var m_secondsBetweenModificationCounter:Number;
        ...
        public function HighlightHintButtonScript(gameEngine:IGameEngine, 
        ...
        override public function visit():int
        {
            if (m_ready && m_isActive)
            {
                ...
                {
                    var secondsElapsed:Number = m_time.frameDeltaSecs();
        ...
        private function addHighlightToButton():void
        {
            ...
            uiComponentManager.addComponentToEntity(m_calloutCreator.createCalloutComponentFromText({
                id:"hintButton", text:"Get Help",
                color:0xFFFFFF, direction:calloutOrientation, width:100, height:calloutHeight, animationPeriod:1,
                closeOnTouchInside: true, closeCallback:removeHighlightFromButton
            }));
