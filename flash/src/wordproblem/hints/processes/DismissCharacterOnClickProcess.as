package wordproblem.hints.processes
{
    ...
    public class DismissCharacterOnClickProcess extends ScriptNode
    {
         ...
         */
        private var m_userPressedOnCharacter:Boolean;
         ...
         */
        private var m_persistentCalloutOpacity:Boolean;
        private var m_mouseInCalloutBoundsLastFrame:Boolean;
        ...
        public function DismissCharacterOnClickProcess(characterAndCalloutControl:HelperCharacterController,
                                                       characterId:String,
        ...
        override public function visit():int
        {
            ...
            else
            {
                ...
                var mouseHitCharacterOnFrame:Boolean = this.getGlobalPointHitCharacterOrCallout(
                    m_characterId,
                ...
                if (!m_persistentCalloutOpacity)
                {
                    ...
                    var calloutComponents:Vector.<Component> = characterComponentManager.getComponentListForType(CalloutComponent.TYPE_ID);
                    var i:int;
                    var hitCallout:Boolean = false;
                    var numCallouts:int = calloutComponents.length;
                    for (i = 0; i < numCallouts; i++)
                    {
                        var calloutComponent:CalloutComponent = calloutComponents[i] as CalloutComponent;
                ...
                var shouldDismissOnFrame:Boolean = false;
                                                            ...
                                                            globalY:Number):Boolean
        {
            ...
            for (i = 0; i < numCallouts; i++)
            {
                ...
                if (calloutComponent.callout != null && calloutComponent.entityId == characterId)
                {
                    ...
                    {
                        var characterView:DisplayObject = (characterComponentManager.getComponentFromEntityIdAndType(characterId, RenderableComponent.TYPE_ID) as RenderableComponent).view;
