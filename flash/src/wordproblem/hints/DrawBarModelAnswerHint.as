package wordproblem.hints
{
     ...
     */
    public class DrawBarModelAnswerHint extends HintScript
    {
        private static const WARNING_TEXT:String = "Can't figure out the right picture? Press show to see the answer. Warning: You won't get credit for solving this problem if you use this hint.";
        ...
        public function DrawBarModelAnswerHint(gameEngine:IGameEngine,
        ...
        override public function getDescription(width:Number, height:Number):DisplayObject
        {
            ...
            else
            {
                ...
                var largestProportionalValue:Number = 0;
                for each (var barWhole:BarWhole in m_referenceBarModel.barWholes)
                {
                    var barWholeValue:Number = barWhole.getValue();
