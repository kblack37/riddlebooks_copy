package wordproblem.hints
{
     ...
     */
    public class DrawBarModelTypeHint extends BasicTextAndCharacterHint
    {
        /**
        ...
        public function DrawBarModelTypeHint(gameEngine:IGameEngine,
        ...
        {
            var descriptionText:XML = <p>You will need to draw the boxes so they look similar to this...</p>;
            var characterText:XML = <p>It looks like this!</p>;
        ...
        override protected function showHints():DisplayObject
        {
            ...
            var calloutWidth:Number = calloutBackground.width;
            var calloutHeight:Number = calloutBackground.height;
            var calloutVerticalPadding:Number = 20;
            var calloutHorizontalPadding:Number = 20;
