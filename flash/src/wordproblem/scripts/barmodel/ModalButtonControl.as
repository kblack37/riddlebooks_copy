package wordproblem.scripts.barmodel
{
    ...
    public class ModalButtonControl implements IDisposable
    {
         ...
         */
        private var m_modeIsActive:Boolean;
         ...
         * over the button.
         */
        private var m_pressStartedInButton:Boolean;
        ...
        private var m_activeColor:uint = 0x6AB24B;
        
        private var m_particleEffect:FollowPathAnimation;
        
        public function ModalButtonControl(gameEngine:IGameEngine, 
                                           ...
                                           onModeChangeCallback:Function)
        {
            ...
            var maxButtonDimension:Number = 48;
         ...
         */
        public function getModeIsActive():Boolean
        {
         ...
         */
        public function setActiveMode(isActive:Boolean):void
        {
            var buttonColor:uint = m_inactiveColor;
            if (isActive)
            {
            ...
            (m_modalButton.getChildAt(0) as Image).color = buttonColor;
         ...
         */
        public function setButtonEnabled(enabled:Boolean):void
        {
            if (enabled)
            {
