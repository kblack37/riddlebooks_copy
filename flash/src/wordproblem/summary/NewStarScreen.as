package wordproblem.summary
{
    ...
    public class NewStarScreen extends Sprite
    {
        public function NewStarScreen(totalScreenWidth:Number, totalScreenHeight:Number, assetManager:AssetManager)
        {
            super();
            ...
            var targetScale:Number = desiredWidth / starTexture.width
