package wordproblem.summary
{
     ...
     */
    public class SummaryObjectivesWidget extends Sprite
    {
        ...
        */
        ...
        private var m_displayWithoutMarksBuffer:Vector.<Sprite>;
        private var m_checkMarkBuffer:Vector.<DisplayObject>;
        ...
        public function SummaryObjectivesWidget(assetManager:AssetManager, juggler:Juggler)
        {
            super();
            ...
            m_displayWithoutMarksBuffer = new Vector.<Sprite>();
            m_checkMarkBuffer = new Vector.<DisplayObject>();
         ...
         */
        public function animateObjectives(objectives:Vector.<BaseObjective>, 
                                          ...
                                          onAnimationComplete:Function):void
        {
            ...
            */
            m_displayWithoutMarksBuffer.length = 0;
            m_checkMarkBuffer.length = 0;
            
            var objectiveYOffset:Number = 0;
        ...
        private function animateObjective(objectiveDisplayWithoutMark:Sprite, completionMark:DisplayObject, completeCallback:Function):void
        {
            ...
            fadeInTween.onComplete = function():void
            {
                ...
                else
                {
                    ...
                    var originalScale:Number = completionMark.scaleX;
        ...
        private function getObjectiveDisplayWithoutMark(objective:BaseObjective):Sprite
        {
            ...
            var totalObjectiveWidth:Number = 270;
            var totalObjectiveHeight:Number = 90;
            ...
            var checkboxHorizontalPadding:Number = 20;
            var checkboxWidth:Number = 40;
            ...
            var maxTextWidth:Number = totalObjectiveWidth - checkboxWidth - checkboxHorizontalPadding - checkbox.x - 10;
            var maxTextHeight:Number = totalObjectiveHeight - 20;
            ...
            var resizedFontSize:Number = m_measuringTextField.resizeToDimensions(maxTextWidth, maxTextHeight, objectiveDescription);
