package wordproblem.summary
{
    ...
    public class NewItemScreen extends Sprite
    {
        /**
        ...
        public function NewItemScreen(totalScreenWidth:Number, 
                                      ...
                                      assetManager:AssetManager)
        {
            ...
            var targetScale:Number = 450 / burstPurpleTexture.width;
            ...
            var rewardIconComponent:RewardIconComponent = itemDataSource.getComponentFromEntityIdAndType(itemId, RewardIconComponent.TYPE_ID) as RewardIconComponent;
            ...
            function showItem():void
            {
                ...
                itemImage.alpha = 0.5;
                var desiredScale:Number = 200 / rewardIconTexture.height;
                ...
                var nameComponent:NameComponent = itemDataSource.getComponentFromEntityIdAndType(itemId, NameComponent.TYPE_ID) as NameComponent;
