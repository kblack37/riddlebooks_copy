package wordproblem.summary
{
     ...
     */
    public class SummaryGradeWidget extends Sprite
    {
        /**
        ...
        private var m_tweensInstantiated:Vector.<Tween>;
        
        public function SummaryGradeWidget(assetManager:AssetManager, juggler:Juggler)
        {
            super();
            
            m_assetManager = assetManager;
            m_juggler = juggler;
            m_tweensInstantiated = new Vector.<Tween>();
            
            // Setup the feedback given to the player depending on the grade
            m_gradeToInformationMap = new Dictionary();
            m_gradeToInformationMap["A+"] = {emotion:"happy", textColor:0x339933, feedback:["AMAZING!!!", "PERFECT!", "WOOOT!"]};
            m_gradeToInformationMap["A"] = {emotion:"happy", textColor:0x009999, feedback:["Great job!", "Fantastic!"]};
            
            var neutralFeedback:Array = ["Well done!", "Good work!", "You got it!"];
            m_gradeToInformationMap["B"] = {emotion:"neutral", textColor:0x3333CC, feedback:neutralFeedback};
            
            var badFeedback:Array = ["There's always next time.", "Don't worry!", "Good try!"];
            m_gradeToInformationMap["C"] = {emotion:"neutral", textColor:0xCC3300, feedback:badFeedback};
        }
        ...
        override public function dispose():void
        {
            ...
            for each (var tween:Tween in m_tweensInstantiated)
            {
                m_juggler.remove(tween);
            }
            m_tweensInstantiated.length = 0;
        }
        ...
        public function animateCharacter(score:int, onAnimationComplete:Function):void
        {
            ...
            var gradeStarTargetScale:Number = 300.0 / gradeStarTexture.width;
            gradeStarImage.scaleX = gradeStarImage.scaleY = gradeStarTargetScale;
            gradeDisplayContainer.addChild(gradeStarImage);
            var textColor:uint = m_gradeToInformationMap[letterGrade].textColor;
            ...
            var characterEmotionToUse:String = (m_gradeToInformationMap.hasOwnProperty(letterGrade)) ?
                m_gradeToInformationMap[letterGrade].emotion : "neutral";
            ...
            */
            ...
            var finalCharacterScale:Number = 0.8;
