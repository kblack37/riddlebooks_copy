package wordproblem.saves
{
     ...
     * state.
     */
    public class RepairSaveData extends BaseBufferEventScript
    {
        ...
        private const MASTER_PROGRESS_SAVE_KEY:String = "master-save";
        
        public function RepairSaveData(gameEngine:IGameEngine,
                                       cache:ICgsUserCache,
        ...
        override protected function processBufferedEvent(eventType:String, param:Object):void
        {
            if (eventType == GameEvent.LEVEL_COMPLETE)
            {
                ...
                {
                    var serializedData:Object = m_saveRepairsCallback();
