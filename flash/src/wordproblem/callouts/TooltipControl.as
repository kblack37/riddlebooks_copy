package wordproblem.callouts
{
     ...
     */
    public class TooltipControl implements IDisposable
    {
        public var textWidth:Number = 80;
        public var textHeight:Number = 40;
         ...
         */
        private var m_thisControlCreatedCallout:Boolean;
        
        public function TooltipControl(gameEngine:IGameEngine,
                                       uiEntityId:String, 
                                       text:String, 
            ...
            if (m_displayHitArea.contains(mouseState.mousePositionThisFrame.x, mouseState.mousePositionThisFrame.y))
            {
                ...
                if (calloutComponent == null && !Layer.getDisplayObjectIsInInactiveLayer(m_objectToGetTooltip) && m_objectToGetTooltip.visible)
                {
                    ...
                    newCalloutComponent.display = new TextField(textWidth, textHeight, m_toolTipText, 
                        m_textStyle.font, m_textStyle.size as int, m_textStyle.color as uint);
                ...
                {
                    var currentText:TextField = (calloutComponent as CalloutComponent).display as TextField;
